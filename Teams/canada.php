<?php
    ...
    if(isset($_SESSION['user_id'])){
        ...
        $stmt = $conn->prepare("SELECT id FROM teams WHERE nombre = 'CANADA
'");
        if($stmt->execute()){
            $row = $stmt->fetch(PDO::FETCH_ASSOC);
            $pais_id = $row['id'];
    ...
    <body>
        ...
        <div class="big-container" id="blur">
            <div class="container" style="width:40%;">
                <div class="wrap">
                    <div class="col">
                        <img class="imagen_bandera" src="../images/shields/CANADA.png">
                    </div>

                    <div class="col">
                        <span class="pais">CANADA</span>
                    </div>
                ...
                <div class="table-container">
                    <table>
                        <?php
                            $stmt = $conn->prepare("SELECT * FROM players WHERE pais = 'CANADA'");
                            $stmt->execute();
            ...
            <div class="small-container">
                <div class="formacion-div">
                    <img class="formacion" src="../images/formaciones/CANADA.jpg">
                    <h2 class="leyenda">Formación de Canada</h2> 
                </div>

                <div class="twitter-div">
                    <a class="twitter-timeline" href="https://twitter.com/CanadaSoccerEN?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor">Tweets by @CanadaSoccerEN</a>
                </div>
            </div>
        </div>
