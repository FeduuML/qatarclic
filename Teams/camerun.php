<?php
    ...
    if(isset($_SESSION['user_id'])){
        ...
        $stmt = $conn->prepare("SELECT id FROM teams WHERE nombre = 'CAMERUN'");
        if($stmt->execute()){
            $row = $stmt->fetch(PDO::FETCH_ASSOC);
            $pais_id = $row['id'];
        }
    ...
    <body>
        ...
        <div class="big-container" id="blur">
            <div class="container" style="width:40%;">
                <div class="wrap">
                    <div class="col">
                        <img class="imagen_bandera" src="../images/shields/CAMERUN.png">
                    </div>

                    <div class="col">
                        <span class="pais">CAMERUN</span>
                    </div>
                ...
                <div class="table-container">
                    <table>
                        <?php
                            $stmt = $conn->prepare("SELECT * FROM players WHERE pais = 'CAMERUN'");
                            $stmt->execute();
            ...
            <div class="small-container">
                <div class="formacion-div">
                    <img class="formacion" src="../images/formaciones/CAMERUN.jpg">
                    <h2 class="leyenda">Formación de Camerun</h2> 
                </div>

                <div class="twitter-div">
                    <a class="twitter-timeline" href="https://twitter.com/fecafootofficie">Tweets by @FecafootOfficie</a>
                </div>
            </div>
        </div>
