    ...
    <body>
        ...
        <header class="header">
            <div class="wrapper">
                ...
                <nav>
                    <a href="../index.php">Modo invitado</a></li>
                </nav>
            </div>
        </header>
                ...
                <form action="#" method="post" id="formulario" class="formulario" autocomplete="off">
                    ...
                    <div class="formulario__grupo" id="grupo__username">
				        <div class="formulario__grupo-input">
                            <input class="formulario__input" type="text" name="username" id="username" placeholder="Nombre de usuario o correo electronico">
				        </div>
			        </div>
                    ...
                    <br>
                    <p class="alternative"> ¿Olvidaste tu contraseña? <a href="forgotpass.php">Clic aqui</a></p>
                </form>
            </section>
        </div>
    </body>
