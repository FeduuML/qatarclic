        ...
        <div class="container">
            ...
            <div class="caja" id="left">
                <div id="carousel2" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="qatar-fotos/974_estadio.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="qatar-fotos/974_estadio3.jpeg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="qatar-fotos/974_estadio2.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
            ...
            <div id="carousel3" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="qatar-fotos/khalifa_estadio.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="qatar-fotos/khalifa_estadio2.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="qatar-fotos/khalifa_estadio3.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
            ...
            <div id="carousel4" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="qatar-fotos/educity_estadio.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="qatar-fotos/educity_estadio2.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="qatar-fotos/educity_estadio3.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
