<?php
    ...
    if(isset($_POST['btn-add'])){
        ...
        $stmt=$conn->prepare("INSERT INTO respuestas_mundialito(id_encuesta, id_usuario, respuesta1, respuesta2, respuesta3, respuesta4, respuesta5) VALUES (3, '$id', :ucont1, :ucont2, :ucont3, :ucont4, :ucont5)");
...
<html>
	...
	<body>
		<div class="container">
            <?php
                $stmt=$conn->prepare('SELECT * FROM `preguntas_mundialito` WHERE id=3');
                $stmt->execute();
                if($stmt->rowCount()>0){
